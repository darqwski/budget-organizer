...
describe("createInitialScoreTableFromAssignments", () => {
  it("should create initial score table from 1 assignment with 3 keys", () => {
    ...
    const result = createInitialScoreTableFromAssignments([mockAssignment1])

    expect(Object.keys(result)).toHaveLength(COMBINATIONS_BY_LENGTH[4])
  })
  ...
  it("should create initial score table from 2 assignment with 3 and 4 keys", () => {
    ...
    const result = createInitialScoreTableFromAssignments([
      mockAssignment1,
      mockAssignment2,
    ])
